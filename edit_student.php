...
// 1. SECURITY CHECK - Siguraduhin na tama ang brackets [] dito
if(!isset($_SESSION['auth']) || $_SESSION['auth_role'] != 'Admin') {
    header("Location: login.php");
    exit(0);
}

// 2. FETCH DATA - Kunin ang details base sa ID
if(isset($_GET['id'])) {
...
// 3. UPDATE LOGIC - Para mag-save ang changes
...
<head>
    ...
    <style>
        ...
        .btn-update { background-color: #ffc107; border: none; font-weight: bold; border-radius: 10px; padding: 12px 30px; color: #fff !important; }
        .btn-update:hover { background-color: #e0a800; }
        .label-style { font-weight: bold; color: #6c757d; font-size: 0.85rem; text-transform: uppercase; }
                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label class="label-style">Roll Number</label>
                                    <input type="text" name="roll_number" value="<?= $student['roll_number']; ?>" class="form-control" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="label-style">Application Type</label>
                                    <select name="application_type" class="form-control">
                                        <option value="Registration" <?= $student['application_type'] == 'Registration' ? 'selected':'' ?>>Registration</option>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label class="label-style">Student Name</label>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <label class="label-style">Grade Level</label>
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <a href="manage_students.php" class="text-muted small"><i class="fas fa-arrow-left mr-1"></i> Cancel and Go Back</a>
